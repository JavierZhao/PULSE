...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='CLIP-style cross-modal contrastive pretraining for WESAD.')
    parser.add_argument('--run_name', type=str, default='clip_style_baseline')
